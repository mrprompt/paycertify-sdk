...
use MrPrompt\PayCertify\Gateway\Recurring\Unsubscribe;
 ...
 */
class UnsubscribeTest extends Base
{
    use Card;
     ...
     * @covers MrPrompt\PayCertify\Gateway\Recurring\Unsubscribe::process
     */
    public function process()
    {
        $subscription = $this->subject();

        $unsubscription = new Unsubscribe($this->client);
        $result = $unsubscription->process($subscription['subscription']['id']);
