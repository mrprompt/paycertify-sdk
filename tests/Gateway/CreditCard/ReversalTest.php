...
use MrPrompt\PayCertify\Gateway\CreditCard\Reversal;
 ...
 */
class ReversalTest extends Base
{
    use Card;
    ...
    private function subject()
    {
        ...
        return $auth->process($authParams);
    }

    /** 
     * @test 
     * @covers MrPrompt\PayCertify\Gateway\Base::__construct
     * @covers MrPrompt\PayCertify\Gateway\CreditCard\Reversal::process
     */
    public function process()
    {
        $auth = $this->subject();

        $charging = new Reversal($this->client);
